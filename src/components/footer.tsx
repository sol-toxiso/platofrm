      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <div className="space-y-3">
                <Button variant="gradient" size="sm" className="group" onClick={() => window.open(siteConfig.appUrl, '_blank')}>
                  <Rocket className="mr-2 h-4 w-4 group-hover:rotate-12 transition-transform duration-300" />
                  {siteConfig.footer.launchCta}
        ...
        >
          <div className="max-w-2xl mx-auto text-center">
            <h3 className="text-2xl font-bold mb-2">{siteConfig.footer.newsletterTitle}</h3>
            <p className="text-muted-foreground mb-6">
              {siteConfig.footer.newsletterSubtitle}
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                type="email"
                placeholder={siteConfig.footer.emailPlaceholder}
              ...
              <Button variant="gradient" className="group">
                {siteConfig.footer.subscribeCta}
                <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform duration-300" />
              </Button>
            </div>
          </div>
