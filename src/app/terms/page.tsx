...
export const metadata: Metadata = {
  ...
  description: `Terms of Service for ${siteConfig.siteName} - Complete Solana DeFi Platform`,
}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                By accessing and using {siteConfig.siteName}, you accept and agree to be bound by the terms and 
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                {siteConfig.siteName} provides a comprehensive Solana DeFi platform including:
              </p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                {siteConfig.siteName} is provided "as is" without warranties of any kind. We do not guarantee:
              </p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                ...
                <a href={`mailto:${siteConfig.email.legal}`} className="text-primary hover:underline">
