...
export const metadata: Metadata = {
  ...
  description: `Privacy Policy for ${siteConfig.siteName} - Complete Solana DeFi Platform`,
}
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                ...
                <a href={`mailto:${siteConfig.email.privacy}`} className="text-primary hover:underline">
